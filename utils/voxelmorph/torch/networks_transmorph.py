...
import numpy as np
import utils.voxelmorph.torch.configs_TransMorph as configs
...
class TransMorph(nn.Module):
    def __init__(self, config):
        ...
        self.transformerForSeg = SpatialTransformer(config.img_size, mode='nearest')
...
CONFIGS = {
    'TransMorph_custom': configs.get_3DTransMorph_config_custom(),
