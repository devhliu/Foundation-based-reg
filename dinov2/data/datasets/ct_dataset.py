...
class _Split(Enum):
    ...
    def length(self) -> int:
        split_lengths = {
            _Split.TRAIN: 482_871, # 1_095_361, # 99_891, # modify this number
            _Split.VAL: 3_088, # modify this number
            _Split.TEST: 100_000,
        }
    ...
    def get_image_relpath(self, actual_index: int, class_id: Optional[str] = None) -> str:
        ...
        basename = f"{class_id}_{actual_index:04d}"
...
class CTDatabase(ExtendedVisionDataset):
    ...
    @property
    def split(self) -> "CTDatabase.Split":
        return self._split
    ...
    def _dump_entries(self) -> None:
        split = self.split
        if split == CTDatabase.Split.TEST:
            dataset = None
